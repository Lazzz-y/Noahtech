import{_ as h}from"./chunks/ArticleMetadata.BuBbIslv.js";import{_ as k,m as t,a as r,u as c,B as d,e as n,x as y,ah as g,o as l,p as D,q as A}from"./chunks/framework.Bi-mNMmX.js";import"./chunks/theme.ulrGMYOD.js";const E=JSON.parse('{"title":"Redis配置文件详解","description":"","frontmatter":{"title":"Redis配置文件详解","author":"Noah","date":"2024/07/07 15:32","categories":["Redis进阶"],"tags":["Redis","Redis进阶"]},"headers":[],"relativePath":"courses/数据库/04-Redis进阶/01-Redis配置文件详解.md","filePath":"courses/数据库/04-Redis进阶/01-Redis配置文件详解.md","lastUpdated":1720612269000}'),o={name:"courses/数据库/04-Redis进阶/01-Redis配置文件详解.md"},F=n("h1",{id:"redis配置文件详解",tabindex:"-1"},[y("Redis配置文件详解 "),n("a",{class:"header-anchor",href:"#redis配置文件详解","aria-label":'Permalink to "Redis配置文件详解"'},"​")],-1),m=g(`<nav class="table-of-contents"><ul></ul></nav><p>Redis 的配置文件通常位于 <code>redis.conf</code> ，在 Redis 启动的的时候，可以自定义配置文件启动以达到伪集群的效果。通过配置文件可以调节 Redis 的行为和性能。</p><details class="details custom-block"><summary>redis.conf 查看</summary><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#768390;"># Redis 配置文件样本</span></span>
